...
<div class="container-fluid">
	...
	<div class="col-lg-12">
		<div class="row">
			<div class="col-md-12">
				<button id="result" class="btn btn-primary btn-sm  col-md-2 float-right" onclick="location.href='voting.php?page=home'">View Results</button>
			</div>
		</div>
		<div class="card">
			<div class="card-body">
